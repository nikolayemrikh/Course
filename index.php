...
<tr><td>
<input type="submit" name="getLogonWindow" value="Войти в систему">
<input type="submit" name="getRegWindow" value="Зарегистрироваться">
</td></tr>
</table>
</form>';
...
<table id="buttons_table">
<tr><td>
<input type="submit" name="getLogonWindow" value=" ОК ">
<input type="submit" name="getStartWindow" value="Вернуться назад">
</td></tr>
</table>
</form>';
   $html = tplLoad($title,$body);
...
<table id="buttons_table">
<tr><td>
<input type="submit" name="getRegWindow" value=" ОК ">
<input type="submit" name="getStartWindow" value="Вернуться назад">
</td></tr>
</table>
</form>';
				...
				//Проверка роли пользователя
						...
						$_SESSION["login"] = $login;
		                              ...
		                              header("Location: owner.php");
		                                $sql="INSERT INTO logon (person,ipAddress,date_) values ('$userID','".$_SERVER["REMOTE_ADDR"]."',sysdate)";
		                                  $stmt = oci_parse($conn, $sql);
		                                oci_execute($stmt);
		                             exit;
		                        case 2:
